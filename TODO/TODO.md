...
10. **Reste (medium/lourd)** : **A7-panneau** « Arclen Preferences » (custom settings UI) ; cacher le node dynamique **Extensions** de l'écran Settings (autre levier) ; **V1** au fil de l'eau ; vérif build packagé.
