...
11. **Reste (medium/lourd)** : **A7-étape 3** rebrand titre « Settings » → « Arclen Preferences » ; (option) enrichir Arclen/Assistant avec d'autres knobs Claude ; résidu « Open Timeline » ; **V1** au fil de l'eau (walkthrough Claude, vocab) ; vérif build packagé.
