...
| IN2 | Licence VSCodium/MS affichée par l'installeur | `code.iss:1-5` macro → `vscode/LICENSE.rtf` (MIT VSCodium+Microsoft) | **moyen** — ⚠️ légal : fork MIT → on DOIT garder les mentions copyright MS+VSCodium ; on peut re-présenter une licence aux couleurs Arclen qui les inclut, **pas** les supprimer (à valider par le user) | ⬜ |
