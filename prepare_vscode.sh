...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "product" "nameShort" "Auraia"
  setpath "product" "nameLong" "Auraia"
  setpath "product" "applicationName" "auraia"
  setpath "product" "dataFolderName" ".auraia"
  setpath "product" "linuxIconName" "auraia"
  setpath "product" "quality" "insider"
  setpath "product" "urlProtocol" "auraia"
  setpath "product" "serverApplicationName" "auraia-server"
  setpath "product" "serverDataFolderName" ".auraia-server"
  setpath "product" "darwinBundleIdentifier" "com.auraia"
  setpath "product" "win32AppUserModelId" "Auraia.Auraia"
  setpath "product" "win32DirName" "Auraia"
  setpath "product" "win32MutexName" "auraia"
  setpath "product" "win32NameVersion" "Auraia"
  setpath "product" "win32RegValueName" "Auraia"
  setpath "product" "win32ShellNameShort" "Auraia"
  ...
  setpath "product" "tunnelApplicationName" "auraia-tunnel"
  setpath "product" "win32TunnelServiceMutex" "auraia-tunnelservice"
  setpath "product" "win32TunnelMutex" "auraia-tunnel"
